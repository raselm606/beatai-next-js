      ...
      <div className="powered_logo">
        <div className="container-fluid"> 
          ...
          <div className="row"  >
            ...
            <div className="col-12 col-sm mb-3">
              <div className="img_powered">
                <Image src={nanoBanana} alt="nanoBanana" />
              </div>
            </div>
            <div className="col-12 col-sm mb-3">
              <div className="img_powered">
            ...
            <div className="col-12 col-sm mb-3">
              <div className="img_powered">
                <Image src={ticketmaster} alt="ticketmaster" />
              </div>
            </div>
            <div className="col-12 col-sm mb-3">
              <div className="img_powered dts">
                <Image src={meetlex} alt="meetlexai" />
              </div>
            </div> 
            <div className="col-12 col-sm mb-3">
              <div className="img_powered dts">
